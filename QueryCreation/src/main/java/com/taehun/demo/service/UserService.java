...
public class UserService {
 ...
 // 성이 특정 값이 아닌 사용자 찾기 (Not 사용)
    public List<UserDTO> findByLastnameNot(String lastname) {
    ...
    // 나이가 특정 범위 안에 있는 사용자 찾기 (In 사용)
    public List<UserDTO> findByAgeIn(List<Integer> ages) {
    ...
    // 나이가 특정 범위 안에 없는 사용자 찾기 (NotIn 사용)
    public List<UserDTO> findByAgeNotIn(List<Integer> ages) {
